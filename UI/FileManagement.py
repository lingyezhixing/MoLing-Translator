            ...
            for file in file_list:
                ...
                if file.endswith(".txt"):
                    ...
                    if os.path.exists(os.path.join(".\Cache\Temp", sha256)):
                        # 检查字典文件是否存在
                        dict_file_path = os.path.join(os.path.dirname(file_path), os.path.basename(file_path)[:-4] + '.json')
                        if os.path.exists(dict_file_path) and os.path.exists(os.path.join(".\Cache\TXT", sha256, 'dict.json')) == False:
                            # 移动到缓存目录
                    ...
                    if os.path.exists(os.path.join(".\Cache\Temp", sha256)):
                        # 检查字典文件是否存在
                        dict_file_path = os.path.join(os.path.dirname(file_path), os.path.basename(file_path)[:-5] + '.json')
                        if os.path.exists(dict_file_path) and os.path.exists(os.path.join(".\Cache\EPUB", sha256, 'dict.json')) == False:
                            # 移动到缓存目录
